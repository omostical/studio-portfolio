# Studio Ted — Autonomous Agent System
...
| 6 | **Product Designer** | Defines high-craft landing page design, interaction patterns, and layout systems to achieve world-class, conversion-focused UI quality | On brief + pre-dev |
| 7 | **Developer** | Builds the actual sites in Next.js/Tailwind | On brief |
| 8 | **UI QA** | Reviews every line of code for modern UI (Awwwards/Godly/Lapa standard) | 20 min |
| 9 | **UX QA** | Reviews user flows, navigation, accessibility, responsiveness | 20 min |
| 10 | **Sales QA** | Reviews conversion optimization, CTAs, trust signals, social proof | 25 min |
| 11 | **Researcher QA** | Ensures no site falls into AI-generated patterns | 15 min |
| 12 | **Dev QA** | Code quality, performance, SEO, accessibility, best practices | 20 min |
| 13 | **Quality QA** | Ensures variety across portfolio — multi-page sites, different structures | 30 min |
| 14 | **SEO Specialist** | Meta tags, structured data, Core Web Vitals, semantic HTML | 30 min |
| 15 | **Growth Strategist** | Analyzes portfolio gaps, suggests what converts best on freelance platforms | 45 min |
| 16 | **Accessibility QA** | WCAG 2.1 AA compliance, keyboard nav, screen readers, color blindness | 20 min |
| 17 | **Color Theory QA** | Color harmony, psychology, contrast ratios, cross-site palette uniqueness | 20 min |
| 18 | **Typography QA** | Font selection, hierarchy, readability, anti-Inter enforcement | 20 min |
| 19 | **Photographer** | Pexels API image curation, no duplicates, editorial-grade only | 20 min |
...
5. **No generic layouts allowed.** Every page must pass Product Designer review for originality, interaction quality, and visual hierarchy before development.
6. **Agreement protocol:** If you disagree with another agent's work, write to `agency/reviews/conflicts/` — the CEO resolves.
...
5. **Product Designer** translates brand + copy into high-fidelity layout, interaction patterns, and section structure
6. **Developer** builds the site
7. **All QA agents** review in parallel, write findings to `agency/reviews/`
8. **Developer** addresses QA findings
9. **CEO** does final sign-off
